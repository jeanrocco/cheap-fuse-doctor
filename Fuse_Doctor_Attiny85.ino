// AVR High-voltage Serial Fuse Reprogrammer<br>    // Adapted from code and design by Paul Willoughby 03/20/2010
    ...
    void setup() {
      ...
      Serial.begin(115200);
      Serial.println("Type any character and press enter when ready");
    }
    ...
    void loop() {
       if (Serial.available() > 0) {
        ...
        switch (sig) {
          case ATTINY13:
            Serial.print(" Attiny13  hex: ");
           break;
          case ATTINY24:
            Serial.print(" Attiny24  hex: ");
           break;
          case ATTINY44:
            Serial.print(" Attiny44  hex: ");
           break;
          case ATTINY84:
            Serial.print(" Attiny84  hex: ");
           break;
          case ATTINY25:
            Serial.print(" Attiny25  hex: ");
           break;
          case ATTINY45:
            Serial.print(" Attiny45  hex: ");
           break;
          case ATTINY85:
            Serial.print(" Attiny85  hex: ");
           break;
          default:
            Serial.print(" No match with my list:Attiny13, 24, 25, 44, 45, 84, & 85 hex: ");
           break;          
        }
